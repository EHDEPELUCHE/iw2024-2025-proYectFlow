...
@RolesAllowed({"ROLE_SOLICITANTE", "ROLE_PROMOTOR", "ROLE_CIO", "ROLE_OTP"})
    ...
    public void setParameter(BeforeEvent event, String parameter) {
        ...
        if (proyecto.isEmpty()) {
            ...
            if (proyectoAux.getEstado() != Proyecto.Estado.solicitado) {
                H2 mensajeNoEditable = new H2("En estos momentos ya no es posible editar el proyecto.");
                getContent().add(mensajeNoEditable);
            } else {
